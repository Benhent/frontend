  ...
  return (
    ...
    >
        ...
        {!isSubmitted ? (
          ...
          <div className="text-center">
            <motion.div
              ...
              className="w-16 h-16 bg-fifth rounded-full flex items-center justify-center mx-auto mb-4"
            >
      ...
      <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
        <Link to="/login" className="text-sm text-fifth hover:underline flex items-center">
